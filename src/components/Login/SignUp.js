...
import Input from "../../shared/components/UIComponents/Input";
      ...
      <div className="card w-96 bg-base-100 shadow-xl">
        <div className="card-body">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <Flex>
              <Input label="Course Name" name="name" type="text" />
              <Input label="Offered Language" name="offered_lang" type="text" />
            </Flex>
