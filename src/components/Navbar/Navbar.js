        ...
        <div className="navbar-start">
          <div className="dropdown">
            ...
            >
              ...
              <li>
                <Link to={"/aboutSuttle"}>AboutUS</Link>
              </li>
              <li>
          ...
          <img
            className="navbarImg"
            src="https://templatekit.jegtheme.com/shuttle/wp-content/uploads/sites/300/2022/06/logo-black-new.png"
            alt=""
          />
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="banner-content pt-8">
          <div data-aos="fade-up">
            <h2 className="text-4xl mb-7 lg:text-6xl text-white font-bold">
              We Are Best <br />{" "}
              <span>
                <span className="text-orange-600">Bus Charter </span>Service
              </span>{" "}
              In The World
            </h2>
          </div>
          ...
          <div className="grid grid-cols-2">
            <div data-aos="fade-left">
              <button className="button px-6 py-3 rounded-full">
