            ...
            <div data-aos="fade-up" className='w-full lg:w-5/6 bg-white rounded-lg mx-auto mt-[-50px] relative  z-50 shadow-lg p-10'>
                ...
                <div className='flex max-w-full gap-0'>
                    <div className='w-full mt-3 '>
                        ...
                        <label htmlFor="my-modal-6" onClick={() => setBookingBus(b)} className="px-6 py-3 bg-orange-700 hover:bg-black text-white text-1xl font-bold rounded-full">Booking Now</label>
