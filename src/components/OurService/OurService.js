            ...
            <div className='grid grid-cols-1 lg:grid-cols-3'>
                ...
                <div className="testimotionals">
                    <div className="card">
                        ...
                        <div className="content">
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nam iusto ea tenetur quas facere minima obcaecati mollitia sed ipsum quod, eius repellat nihil Shidul is ipsa veritatis magni voluptates voluptatumsed ipsum quod, eius repellat nihil quos. Saepe ipsa veritatis magni voluptates voluptatum..</p>
                            <div className="image">
